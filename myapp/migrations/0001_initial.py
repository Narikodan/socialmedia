# Generated by Django 4.2.1 on 2023-07-28 06:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('comments', models.ManyToManyField(related_name='comments', to='myapp.comment')),
                ('likes', models.ManyToManyField(related_name='liked_posts', through='myapp.Like', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='comment',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment_set', to='myapp.post'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
